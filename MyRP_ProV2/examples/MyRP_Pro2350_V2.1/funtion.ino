    ...
    for(int i=0; i< num; i++)
      {
        while(1)
          {
            delay(5);      
            if(analogRead(47) < md_sensorC(1)-50 && analogRead(46) > md_sensorC(0)-50)
              {
                Motor(-5 ,20);
              }
            else if(analogRead(47) > md_sensorC(1)-50 && analogRead(46) < md_sensorC(0)-50)
              {
                Motor(20 ,-5);
              }
            else if(analogRead(47) > md_sensorC(1)-50 && analogRead(46) > md_sensorC(0)-50)
