...
void setup() 
  {
     ...
     //-------------------------------------------------------ปรับทิมเซอร์โว
      ...
      trim_servo_3(2);   // arm_hand ขวา   ค่ามากกางออก
      trim_servo_4(-2);  // arm_can ซ้าย  ค่าน้อยไปข้างหน้า
      trim_servo_5(5);  // arm_can ขวา   ค่าน้อยไปข้างหน้า   5
      ...
      set_pid_turnL(0.952f, 0.000f, 0.09f);   //-->>  ตั้งค่า pid ในการหมุนตัว  
      set_pid_turnR(0.952f, 0.000f, 0.09f);   //  หมุนแรงน้อยไปไม่ถึง เพิ่มค่าตัวแรก  
