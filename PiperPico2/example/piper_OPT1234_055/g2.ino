void mission_2() 
  {
    ...
    arm_updown(13); 
    go_to_mission_on_stand('L',  70, 9);   // ตัวแปรตัวสุดท้ายคือ ความสูงของแขน  เดินวางสีแดง
    move(-40,  -40, 1.5, 20, 10, 17);
    armR_to_armL();  //------->> เปลี่ยนกระป๋องจากมือ ขวา ไปมือ ซ้าย

    can_to_armR();    //เอากระป๋องจากที่ช่องขวา ไปให้มือขวา
     arm_updown(13); 
     go_to_mission_on_stand('R',  60, 11);   // ตัวแปรตัวสุดท้ายคือ ความสูงของแขน
   ...
   arm_bridge();
    ...
    turnGyro(70, 90, true);
    arm_updown(19); 
    go_to_mission_on_stand('L',  70, 17);   // ตัวแปรตัวสุดท้ายคือ ความสูงของแขน  เดินวางสีแดง
    move(-40,  -40, 1.5, 20, 10, 17);
    armR_to_armL();  //------->> เปลี่ยนกระป๋องจากมือ ขวา ไปมือ ซ้าย

    can_to_armR();    //เอากระป๋องจากที่ช่องขวา ไปให้มือขวา
     arm_updown(19); 
     go_to_mission_on_stand('R',  60, 17);   // ตัวแปรตัวสุดท้ายคือ ความสูงของแขน
