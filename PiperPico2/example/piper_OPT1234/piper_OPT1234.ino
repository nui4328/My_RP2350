...
void setup() {
    ...
    trim_servo_4(5);
    trim_servo_5(0);
    set_PULSES_updown(210);        // ตั้งค่า ewncoder ระยะขึ้นลงของแขน
    ...
    Set_travel_distance_to_turnGyro(60);  //---->> ตั้งค่าระยะเดินออกจากเส้นก่อนหมุนตัวหลังจากใช้ คำสั่งsetrobot_bw(2);
