...
class my_GYRO1601 {
public:
  static const uint8_t my_GYRO1601_CHIP_ID = 0x00; // Register for chip ID
  static const uint8_t my_GYRO1601_CMD = 0x7E;     // Command register
  static const uint8_t my_GYRO1601_ACCEL_CONF = 0x40; // Accelerometer config
  static const uint8_t my_GYRO1601_ACCEL_RANGE = 0x41; // Accelerometer range
  static const uint8_t my_GYRO1601_GYRO_CONF = 0x42;  // Gyroscope config
  static const uint8_t my_GYRO1601_GYRO_RANGE = 0x43; // Gyroscope range
  static const uint8_t my_GYRO1601_GYRO_DATA = 0x0C;  // Data register start
