...
{
    target_cm = constrain(target_cm, 0.0f, 20.0f);
    ...
    if (arm_moving) {
     ...
     Serial.println(last_PULSES_up);delay(10);
...
void arm_updown_nonblocking(float target_cm)
{
    ...
    int start_speed = going_up ? 45 : 18;        // ← ลงช้าครึ่งหนึ่ง
